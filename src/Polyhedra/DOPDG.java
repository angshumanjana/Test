...
public class DOPDG
{
	...
	public int[][] main(File inputMain,InputHandler iw)
	{
		...
		try
		{
			...
			bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("output2.txt")));
			String line;
			int lineCount=0;
...
//				System.out.println(line);
			...
			BufferedReader br11 = new BufferedReader(new InputStreamReader(new FileInputStream("output2.txt")));
			int yyyy = 0;
			...
			br3 = new BufferedReader(new InputStreamReader(new FileInputStream("output2.txt")));
			String line2 = null;
		...
		finally
		{
			...
			//ResultSetModule.main(OutputArray, Identifiers);
			return OutputArray;
		}
	}
	...
	/**
	 *
	 * Checks whether the given statement is a database statement
	 * @param statement
	 * @return boolean
	 */
